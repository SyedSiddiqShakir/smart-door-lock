...
function startRealTimeUpdates() {
    ...
    setInterval(updateCameraFeed, 2000);     // Every 2 seconds
}
...
function updateCameraFeed() {
    ...
    feedEl.style.backgroundImage = `url('${API_BASE}/api/camera/snapshot?t=${timestamp}')`;
    feedEl.style.backgroundSize = 'cover';
    feedEl.style.backgroundPosition = 'center';
    feedEl.textContent = ''; // Clear placeholder text
}
